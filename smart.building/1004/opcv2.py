...
# 사용자별로 모델을 학습하는 함수
def train(name):
    data_path = "D://bong//bmproject.1//Facial-Recognition-master//faces//" + name + '/'
    ...
    # 학습된 모델 저장
    model_dir = 'D://bong//bmproject.1//Facial-Recognition-master//models//'
...
# 모든 사용자를 학습하는 함수
def trains():
    data_path = "D://bong//bmproject.1//Facial-Recognition-master//faces//"
