...
def face_detector(img):
    ...
    for (x, y, w, h) in faces:
        ...
        # 얼굴 영역에 네모 그리기
        cv2.rectangle(img, (x, y), (x+w, y+h), (255, 0, 0), 2)  # BGR 색상 (파란색)
        return img, roi, faces[0]  # 얼굴 영역과 위치 반환
    ...
    while True:
        ...
        try:
            ...
            if face is not None:
                ...
                # 신뢰도가 85 이상일 때 cnt == 10일 때 서버에 신호를 줄 것 
...
if __name__ == "__main__":
    stranger_dir = "D://bong//bmproject3.5//Facial-Recognition-master//stranger//"  # 실패한 사진 저장 경로
    models = load_models()
    if len(models) == 0:
